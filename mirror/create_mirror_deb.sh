...
echo 'deb [arch=amd64] http://repo.saltstack.com/apt/ubuntu/14.04/amd64/archive/2016.3.8/ trusty main' > /etc/apt/sources.list.d/saltstack.list
curl -L 'http://repo.saltstack.com/apt/ubuntu/14.04/amd64/archive/2016.3.8/SALTSTACK-GPG-KEY.pub' | apt-key add -
